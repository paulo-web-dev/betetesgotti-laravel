...
<!-- BEGIN: Personal Information -->
    <div class="intro-y box mt-5">
        ...
        <form action="{{route('upd-noticias')}}" enctype="multipart/form-data"  method="post">
        <input type="hidden" name="id" value="{{$noticia->id}}">
            <div class="p-5"> 
                    ...
                    <div class="col-span-12 xl:col-span-6">
                        ...
                        <div class="mt-3">
                            ...
                            <input id="update-profile-form-7" type="text" name="titulo" class="form-control"
                                placeholder="Título da Notícia" value="{{$noticia->titulo}}" required>
                        </div>
                         <div class="mt-3"  id="link">
                            <label for="update-profile-form-7" class="form-label"><strong>Texto</strong></label>
                            <textarea required class="form-control editor" name="noticia" id="editor" cols="30" rows="40">`{{$noticia->noticia}}</textarea>
                        </div>
                ...
                <div class="flex justify-end mt-4">
                    <button type="submit" class="btn btn-primary w-40 mr-auto">Atualizar Notícia</button>  
