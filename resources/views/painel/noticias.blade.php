...
@section('content')
    ...
    <h2 class="intro-y text-lg font-medium mt-10">
     ...
     <a href="{{route('form-noticias')}}" data-theme="light" class="tooltip btn btn-primary"  title="Clique aqui para adicionar uma notícia"><i data-feather="plus" class="w-4 h-4 mr-2"></i> Adicionar Noticias</a>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <!-- BEGIN: Users Layout -->
         ...
         @foreach ($noticias as $noticia)
                ...
                <div class="box h-72">
                    ...
                    <div class="flex items-start px-5 pt-5">
                        ...
                        <div class="w-full flex flex-col lg:flex-row items-center">
                            ...
                            <div class="lg:ml-4 text-center lg:text-left mt-3 lg:mt-0">
                                ...
                                <a href="{{route('info-noticia', ['noticia' => $noticia->id])}}"

                                    class="font-medium">{{ $noticia->titulo }}</a>

                                <div class="text-gray-600 text-xs mt-0.5">{{ $noticia->autor }}</div>
                            ...
                            <div class="dropdown-menu w-40">
                                ...
                                <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                                    ...
                                    <a href="javascript:;" data-toggle="modal"
                                        ...
                                        data-target="#excluirProfessor{{ $noticia->id }}"
                    ...
                    <div class="text-center lg:text-left p-5">
                        ...
                        <div class="flex items-center justify-center lg:justify-start text-gray-600 mt-5"> <i
                                ...
                                data-feather="mail" class="w-3 h-3 mr-2"></i> {{ $noticia->created_at }} </div>
                        <img src="{{url("fotos-noticias/$noticia->foto")}}">
            ...
            <div id="excluirProfessor{{ $noticia->id }}" class="modal" tabindex="-1" aria-hidden="true">
