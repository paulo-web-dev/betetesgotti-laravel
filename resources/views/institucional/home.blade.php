  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
      <h1 style="font-size: 36px;">Seja bem-vindo </h1>
        <h2> Somos o escritório de advocacia Betete e Sgotti. Estamos aqui para oferecer serviços jurídicos especializados com uma abordagem humanizada e fundamentada nos direitos humanos, promovendo o acesso à justiça e a defesa dos direitos de nossos clientes. 
</h2>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <span>Serviços</span>
          <h2>Serviços</h2>
          <p>​A Betete Sgotti Advocacia oferece atendimento ao cliente direcionada à solução de conflitos. Assim, soluções extrajudiciais como: mediação de acordos, notificação, elaboração de contratos, elaboração de confissão de dívida entre outras soluções administrativas. No âmbito judicial: elaboração de ações, recursos e audiências. </p>
        </div>
